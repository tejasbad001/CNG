<%@page import="com.r3sys.connection.Db_connection.*" %>
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                        	<a href="Loginstation.html" class="nav-item nav-link active">Log Out</a>
                        	 <ul>
						        ...
						        <li><a href="LoginStation?action1=UpdateCng">Update Cng Station Gs</a></li>
						 	</ul>
                        </div>
                    </div>
                     <div class="nav-item dropdown">
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="Index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Cng Station</h3>
                            </a>
