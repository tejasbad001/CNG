        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <div class="container-fluid pt-4 px-4">
                        <h3>"Gas up with Confidence, Drive with Pride."</h3>
				<br>
				<div style="max-width:100%">
	  			<img class="mySlides"  src="CngCS.jpg" width=1000 height=500 border=20>
	  			<img class="mySlides"  src="Cng3.jpg" width=1000 height=500 border=20>
	   			...
	   			<img class="mySlides"  src="Cng.png" width=1000 height=500 border=20>
