        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
               ...
               <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Cng Station</a>
                        <div class="dropdown-menu bg-transparent border-0">
                        	<a href="LoginStation.html" class="nav-item nav-link active">Log Out</a>
                        	 <ul>
						        <li><a href="LoginStation?action1=ViewStation">View Cng Station</a></li>
						        <li><a href="LoginStation?action1=UpdateCng">Update Cng Station Gas</a></li>
						 	</ul>
                        </div>
                    </div>
                      <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                        	<a href="LoginStation.html" class="nav-item nav-link active">Log Out</a>
                        	 <ul>
						        <li><a href="UserLogin?action2=ViewStation">View Cng Station</a></li>
						 	</ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h3 class="mb-0"><u><i>"Clean Cng, Endless Journeys."</i></u></h3>
						<hr>
                    </div>
                    <div class="container-fluid pt-4 px-4">
                        <h3>"Gassed up with Confidence, Drive with Pride."</h3>
				<br>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="http://localhost:3306/Vehical_cng_booking_app_r3sys/">Cng Booking Finder</a>, All Right Reserved. 
                        </div>
